...
| タスク | 必須参照 | 推奨参照 |
|---|---|---|
| **パフォーマンス分析** | kpi-targets.md | operation-rules.md |
| **変更提案の生成** | approval-rules.md, kpi-targets.md | operation-rules.md, platforms.md |
| **予算変更** | approval-rules.md, operation-rules.md | kpi-targets.md |
| **新キャンペーン作成** | platforms.md, approval-rules.md | kpi-targets.md, ブランドKB |
| **広告クリエイティブ作成** | ブランドKB §1 EVP, §11 ファクトシート | ブランドKB §4 ブランドボイス, §6 アンチパターン |
| **週次/月次レポート** | kpi-targets.md | operation-rules.md |
| **監査** | approval-rules.md, operation-rules.md | platforms.md |

## タスク別フロー

### A. パフォーマンス分析（/recruit:ad:analyze）

1. **設定読み込み**: kpi-targets.md
2. **データ取得**: Notion広報運用DB or GAS経由でMeta/Google Adsデータ
3. **KPI照合**:
   - 採用CPA: 訪問看護 ¥8,000目標 / デイサービス ¥6,000目標
   - 閾値超過（130%）でアラート
4. **分析結果をNotionに記録 + Slack通知**
